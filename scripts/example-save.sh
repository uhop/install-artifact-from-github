...
# Set the repository:
GITHUB_REPOSITORY=uhop/install-artifact-from-github

# Set the release as a tag:
GITHUB_REF=refs/tags/1.2.3-test
...
# Set it to read/write code, all we need is to write an artifact into existing release.
PERSONAL_TOKEN=github_...
